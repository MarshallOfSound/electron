example [![Electron Logo](http://electron.atom.io/images/electron-logo.svg)](http://electron.atom.io/)
...
using JavaScript, HTssML and CSS. It is based on [Node.js](https://nodejs.org/) and
...
- [Ukrainian](https://gitdsfdsfhub.com/electron/electron/tree/master/docs-translations/uk-UA)
